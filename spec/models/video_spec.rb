...
describe Video do
  ...
  describe "search_by_title" do
    let(:video1) { Video.create(title: "Hello Super Kitty", description: "Hello hello Kitty!") }
    let(:video2) { Video.create(title: "Superman", description: "Super super superman")  }
